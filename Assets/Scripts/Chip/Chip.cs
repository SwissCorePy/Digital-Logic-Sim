...
namespace Chip
{
    public class Chip : MonoBehaviour
    {
        ...
        {
            if (_lastSimulationInitFrame == Simulation.simulationFrame) return;
        ...
        public virtual void ReceiveInputSignal(Pin pin)
        {
            ...
            if (_numInputSignalsReceived == inputPins.Length) ProcessOutput();
        }
        ...
        private void ProcessCycleAndUnconnectedInputs()
        {
            foreach (var inputPin in inputPins)
                ...
                else if (!inputPin.parentPin) inputPin.ReceiveSignal(0);
