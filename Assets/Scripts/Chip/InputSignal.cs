...
// When designing a chip, this input signal can be manually set to 0 or 1 by the
// player.
namespace Chip {
public class InputSignal : ChipSignal {
  ...
  public void SendSignal() { outputPins[0].ReceiveSignal(currentState); }

  private void SetCol() { SetDisplayState(currentState); }
