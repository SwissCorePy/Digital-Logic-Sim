...
namespace Save_System
{
    public class SaveCompatibility : MonoBehaviour
    {
        ...
        public static dynamic FixSaveCompatibility(string chipSaveString)
        {
            ...
            for (var i = 0; i < lol.savedComponentChips.Count; i++)
            {
                ...
                lol.savedComponentChips[i].outputPins =
                    JsonConvert.DeserializeObject<dynamic>(JsonConvert.SerializeObject(newValue));

                // Add to all 'inputPins' dictionary the property 'wireType' with a value of 0 (at version 0.25 buses
                // did not exist so its impossible for the wire to be of other type)
                ...
                lol.savedComponentChips[i].inputPins =
                    JsonConvert.DeserializeObject<dynamic>(JsonConvert.SerializeObject(newValue2));
            }
        ...
        private class InputPin
        {
            ...
            [JsonProperty("isCylic")] public bool isCyclic { get; set; }
