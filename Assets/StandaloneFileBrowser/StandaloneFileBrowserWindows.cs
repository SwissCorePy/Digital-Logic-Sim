...
// - WindowWrapper class and GetActiveWindow() are required for modal file
// dialog.
// - "PlayerSettings/Visible In Background" should be enabled, otherwise when
// file dialog opened app window minimizes automatically.
...
public class StandaloneFileBrowserWindows : IStandaloneFileBrowser {
  ...
  public string[] OpenFolderPanel(string title, string directory,
    ...
    var res = fd.ShowDialog(new WindowWrapper(GetActiveWindow()));
    var filenames =
        res == DialogResult.OK ? new[] { fd.SelectedPath } : new string[0];
    fd.Dispose();
    return filenames;
  }
