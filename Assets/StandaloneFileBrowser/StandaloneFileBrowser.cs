...
public class StandaloneFileBrowser {
  ...
  /// <returns>Returns array of chosen paths. Zero length array when
  /// cancelled</returns>
  ...
  /// <param name="title">Dialog title</param>
  /// <param name="directory">Root directory</param>
  /// <param name="extensions">List of extension filters. Filter Example: new
  /// ExtensionFilter("Image Files", "jpg", "png")</param> <param
  /// name="multiselect">Allow multiple file selection</param> <returns>Returns
  /// array of chosen paths. Zero length array when cancelled</returns>
  public static string[] OpenFilePanel(string title, string directory,
                                       ExtensionFilter[] extensions,
                                       bool multiselect) {
    return _platformWrapper.OpenFilePanel(title, directory, extensions,
                                          multiselect);
  }
  ...
  /// <param name="extensions">List of extension filters. Filter Example: new
  /// ExtensionFilter("Image Files", "jpg", "png")</param> <param
  /// name="multiselect">Allow multiple file selection</param> <param
  /// name="cb">Callback")</param>
  public static void OpenFilePanelAsync(string title, string directory,
                                        ExtensionFilter[] extensions,
                                        bool multiselect, Action<string[]> cb) {
    _platformWrapper.OpenFilePanelAsync(title, directory, extensions,
                                        multiselect, cb);
  }
  ...
  /// <param name="multiselect"></param>
  /// <param name="cb">Callback")</param>
  public static void OpenFolderPanelAsync(string title, string directory,
                                          bool multiselect,
                                          Action<string[]> cb) {
  ...
  public static string SaveFilePanel(string title, string directory,
  ...
  /// <param name="defaultName">Default file name</param>
  /// <param name="extensions">List of extension filters. Filter Example: new
  /// ExtensionFilter("Image Files", "jpg", "png")</param> <returns>Returns
  /// chosen path. Empty string when cancelled</returns>
  public static string SaveFilePanel(string title, string directory,
                                     string defaultName,
                                     ExtensionFilter[] extensions) {
    return _platformWrapper.SaveFilePanel(title, directory, defaultName,
                                          extensions);
  }
  ...
  /// <param name="extension">File extension</param>
  /// <param name="cb">Callback")</param>
  public static void SaveFilePanelAsync(string title, string directory,
                                        string defaultName, string extension,
                                        Action<string> cb) {
    var extensions = string.IsNullOrEmpty(extension)
                         ? null
  ...
  public static void SaveFilePanelAsync(string title, string directory,
                                        ...
                                        ExtensionFilter[] extensions,
                                        Action<string> cb) {
    _platformWrapper.SaveFilePanelAsync(title, directory, defaultName,
                                        extensions, cb);
  }
}
}