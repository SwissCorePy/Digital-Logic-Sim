...
public class CanvasSampleSaveFileImage : MonoBehaviour, IPointerDownHandler {
    ...
    private static extern void DownloadFile(string gameObjectName,
    ...
    public void OnPointerDown(PointerEventData eventData) {
        DownloadFile(gameObject.name, "OnFileDownload", "sample.png",
                     _textureBytes, _textureBytes.Length);
    }
    ...
    public void OnClick() {
        var path =
            StandaloneFileBrowser.SaveFilePanel("Title", "", "sample", "png");
